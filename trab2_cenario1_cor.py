...
c  = [2, 1.5, 2, 5.9, 8.1, 13, 14.7, 51, 33.12, 8, 15.6, 2, 3, 3, 11.8, 43.47, 20, 4.9, 2.36, 89, 89, 3.9]              #Lucro por unidade de produto;
g  = [640, 630, 1512, 13950, 112404, 20160, 15876, 30618, 5985, 560, 4851, 7942, 12060, 33840, 11232, 10800]            #Volume de cada produto que necessita geladeira;
...
print(len(c), len(g), len(k), len(fc))
