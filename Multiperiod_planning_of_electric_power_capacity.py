...
c = [120, 500, 110, 50, 100, 90, 80, 22, 30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140]   #Custo unitário x;
n = [20, 40, 60, 80, 100, 500, 40, 70, 55, 65, 75, 85, 95, 105, 25, 125, 135, 145, 155, 165]    #Custo unitário y;
d = [200 + 20*t for t in range(T)]                                                              #Demanda (exemplo);
