...
h.addRow(demanda, highspy.kHighsInf, 5, [0, 3, 4, 5, 6], [1, 1, 1, 1, 1])
h.addRow(demanda, highspy.kHighsInf, 5, [0, 1, 4, 5, 6], [1, 1, 1, 1, 1])
h.addRow(demanda, highspy.kHighsInf, 5, [0, 1, 2, 5, 6], [1, 1, 1, 1, 1])
h.addRow(demanda, highspy.kHighsInf, 5, [0, 1, 2, 3, 6], [1, 1, 1, 1, 1])
h.addRow(demanda, highspy.kHighsInf, 5, [0, 1, 2, 3, 4], [1, 1, 1, 1, 1])
h.addRow(demanda, highspy.kHighsInf, 5, [1, 2, 3, 4, 5], [1, 1, 1, 1, 1])
h.addRow(demanda, highspy.kHighsInf, 5, [2, 3, 4, 5, 6], [1, 1, 1, 1, 1])
